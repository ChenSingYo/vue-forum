  ...
  <div class="album py-5 bg-light">
    <div class="container">
       <UserProfileCard
          ...
          @switch-is-followed="switchIsFollowed"
       />
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-8">
          ...
          <br />
          <UserFavRestaurantsCard  :favorited-restaurants="favoritedRestaurants"/>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    fetchUser () {
      ...
      this.user = {
        ...this.user,
        id: id, // data中的id賦值為dummydata裡的id
        image,
        name,
        email,
